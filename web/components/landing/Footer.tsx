...
export function Footer({ narrow = false }: { narrow?: boolean } = {}) {
  const cols = [["Main", [["Home", "/"], ["What We Do", "/#what"], ["Console", "/app"], ["News", "/app/news"], ["Methods", "/app/methods"]]], ["Company", [["Contact", "mailto:ss4497@cornell.edu"], ["Terms Conditions", "/legal#terms"], ["Privacy Policy", "/legal#privacy"], ["Security", "/legal#security"]]]] as const;
  return (

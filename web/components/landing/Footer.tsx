    ...
    <footer className="footer">
      <div className="max-w-[1860px] mx-auto px-8 md:px-[72px] py-16">
        <div className="flex flex-col md:flex-row justify-between gap-12">
          <div><Logo size={26} light /><p className="text-[13px] mt-6 max-w-sm" style={{ color: "#c7d0dd" }}>Provider integrity for health plans and Medicaid programs, built on public federal and state records.</p></div>

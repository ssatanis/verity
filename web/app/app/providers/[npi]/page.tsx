    ...
    <div>
      ...
      <div className="grid md:grid-cols-[1.4fr_1fr] gap-6 mt-8">
        <div className="space-y-6">
          ...
          </div> : nppes ? <div className="card-2 p-5 text-[13px]">{!reg ? "Billing history could not be checked: the local warehouse is not reachable right now. The risk row above comes from the published tables and is unaffected." : "No Medicaid or Medicare payments are recorded for this NPI in the public files loaded (Medicaid 2018 to 2024; Medicare Part B, Part D, DME and post-acute care 2013 to 2024)."}</div> : null}

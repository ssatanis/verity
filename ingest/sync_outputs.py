...
summ["totals"] = dict(
    ...
    risk_tier3=con.execute("SELECT COUNT(*) FROM provider_risk WHERE tier = 3").fetchone()[0] if "provider_risk" in have else None,
    risk_tier4=con.execute("SELECT COUNT(*) FROM provider_risk WHERE tier = 4").fetchone()[0] if "provider_risk" in have else None,
    risk_tier5=con.execute("SELECT COUNT(*) FROM provider_risk WHERE tier = 5").fetchone()[0] if "provider_risk" in have else None,

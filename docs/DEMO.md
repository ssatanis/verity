...
2. **Console login (10 s).** Reviewer sign in. The console names organizations, so access is controlled.
...
7. **Community page (25 s).** The graph: providers, owners, suites, phones; dashed outline means on a list; hubs held out. Features with robust z-scores. Members with incorporation dates.
